...
interface ManagerDB {
    ...
    @Query("SELECT * FROM categories as c, category_products as cp WHERE cp.product_id = :index AND c._id = cp.category_id")
    List<Category> selectProductCategories(int index);
